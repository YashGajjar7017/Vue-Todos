...
// const store: Module<PostStateProps, RootState> = {
//   state: { postList: [] },
//   actions: {
//     add({ commit }: ActionContext<PostStateProps, RootState>, payload: string) {
//       commit('insert', payload);
//     },
//   },
//   mutations: {
//     insert(state: PostStateProps, content: string) {
//       state.postList.push({ id: getId(), content, noteColor: '#ffffff', isFinish: false });
//     },
//   },
// };
